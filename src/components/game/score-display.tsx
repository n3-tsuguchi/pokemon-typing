...
export function ScoreDisplay({ score, totalAttempts, streak, showCorrectEffect, personalBest }: Props) {
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="flex justify-center">
        {isNewBest ? (
          <span className="animate-badge-pulse inline-flex items-center gap-1 rounded-full bg-gradient-to-r from-yellow-400 to-amber-400 px-3 py-1 text-[10px] sm:text-xs font-bold text-white shadow-sm">
            &#x1F389; NEW BEST!
          </span>
        ) : personalBest > 0 ? (
