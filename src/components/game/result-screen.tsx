    ...
    <div className="flex min-h-[80vh] items-center justify-center px-4">
      <div className="animate-result-reveal w-full max-w-md">
        ...
        <div className="overflow-hidden rounded-3xl bg-white shadow-2xl shadow-gray-200/50 border border-gray-100">
          {/* Header gradient */}
          <div className={`bg-gradient-to-r ${rank.bg} px-8 py-6 text-center text-white`}>
            <p className="text-5xl mb-2">{rank.emoji}</p>
            <h2 className="text-2xl font-bold mb-1">結果発表</h2>
            <p className="text-sm font-medium opacity-90">{rank.label}</p>
          </div>
          ...
          <div className="px-8 py-6">
            ...
            <div className="mb-6 text-center">
              ...
              <p className="text-6xl font-extrabold bg-gradient-to-r from-green-500 to-emerald-500 bg-clip-text text-transparent">
                {score}
              </p>
            </div>
            ...
            <a
              href="/game"
              className="flex w-full items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-red-500 to-red-600 px-6 py-3.5 font-bold text-white shadow-lg shadow-red-500/20 transition-all hover:shadow-xl hover:brightness-110 active:scale-[0.98]"
            >
            ...
            <a
              href="/records"
              className="mt-3 flex w-full items-center justify-center gap-2 rounded-2xl border border-gray-200 bg-white px-6 py-3 font-medium text-gray-600 transition-all hover:bg-gray-50 hover:border-gray-300"
            >
